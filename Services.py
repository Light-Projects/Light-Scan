...
Services_UDP = {
    ...
    3861: "winshadow-hd",
    3862: "giga-pocket",
    3863: "asap-tcp/asap-udp/asap-sctp",
    3864: "asap-tcp-tls/Reserved/asap-sctp-tls",
    3865: "xpl",
    3866: "dzdaemon",
    3867: "dzoglserver",
    3868: "diameter/Reserved",
    3869: "ovsam-mgmt",
    3870: "ovsam-d-agent",
    3871: "avocent-adsap",
    3872: "oem-agent",
    ...
    9090: "websm",
    9091: "xmltec-xmlmail",
    9092: "xmlipcreg svc",  # XmlIpcRegSvc
    9093: "reserved",
    9100: "pdl-datastream",
    9101: "bacula-dir",
    9102: "bacula-fd",
    ...
    9877: "reserved",
    9878: "kca-service",
    9879: "reserved",  # actually unassigned but keeping pattern
    9888: "cyborg-systems",
    9889: "gt-proxy",
    9898: "monkeycom",
    9899: "sctp-tunneling",
...
Services_TCP = {
    ...
    4082: "lorica-out",
    4083: "lorica-out-sec",
    4084: "Reserved",  # Reserved port
    4085: "ezmessagesrv",
    4086: "Reserved",  # Reserved port
    4087: "applusservice",
    4088: "npsp",
    4089: "opencore",
    4090: "omasgport",
    ...
    4340: "gaia",
    4341: "Reserved",  # Reserved port
    4342: "Reserved",  # Reserved port
    4343: "unicall",
    4344: "vinainstall",
    4345: "m4-network-as",
    4346: "elanlm",
    ...
    4359: "omabcastltkm",
    4360: "matrix-vnet",
    4361: "Reserved",  # Reserved port
    4362: "Reserved",  # Reserved port
    4366: "Reserved",  # Reserved port
    4368: "wxbrief",
    4369: "epmd",
    4370: "elpro-tunnel",
    4371: "l2c-control",
    ...
    4410: "itwo-server",
    4411: "found",
    4412: "Reserved",  # Reserved port
    4413: "vision-mon",
    4414: "updog",
    4415: "brcd-vr-req",
    4416: "pjj-player",
    4417: "workflowdir",
    4418: "Reserved",  # Reserved port
    4419: "cbp",
    4420: "nvme",
    4421: "scaleft",
    4422: "tsepisp",
    ...
    4555: "rsip",
    4556: "dtn-bundle",
    4557: "Reserved",  # Reserved port
    4558: "Reserved",  # Reserved port
    4559: "hylafax",
    4563: "amahi-anywhere",
    4566: "kwtc",
    4567: "tram",
    ...
    4711: "trinity-dist",
    4725: "truckstar",
    4726: "Reserved",  # Reserved port
    4728: "capmux",
    4729: "Reserved",  # Reserved port
    4730: "gearman",
    4731: "remcap",
    4732: "Reserved",  # Reserved port
    4733: "resorcs",
    4737: "ipdr-sp",
    4738: "solera-lpn",
    4739: "ipfix",
    ...
    4744: "ifsp",
    4745: "fmp",
    4746: "Reserved",  # Reserved port
    4749: "profilemac",
    4750: "ssad",
    4751: "spocp",
    4752: "snap",
    4753: "simon",
    4754: "Reserved",  # Reserved port
    4755: "Reserved",  # Reserved port
    4756: "RDCenter",
    4774: "converge",
    4784: "bfd-multi-ctl",
    4785: "Reserved",  # Reserved port
    4786: "smart-install",
    4787: "sia-ctrl-plane",
    4788: "xmcp",
    4789: "Reserved",  # Reserved port
    4790: "Reserved",  # Reserved port
    4791: "Reserved",  # Reserved port
    4792: "unified-bus",
    4793: "Reserved",  # Reserved port
    4800: "iims",
    4801: "iwec",
    4802: "ilss",
    4803: "notateit",
    4804: "Reserved",  # Reserved port
    4827: "htcp",
    4837: "varadero-0",
    4838: "varadero-1",
    4839: "varadero-2",
    ...
    4876: "tritium-can",
    4877: "lmcs",
    4878: "Reserved",  # Reserved port
    4879: "wsdl-event",
    4880: "hislip",
    4881: "Reserved",  # Reserved port
    4882: "Reserved",  # Reserved port
    4883: "wmlserver",
    4884: "hivestor",
    4885: "abbs",
    4888: "xcap-portal",
    ...
    4914: "bones",
    4915: "frcs",
    4936: "Reserved",  # Reserved port
    4937: "Reserved",  # Reserved port
    4940: "eq-office-4940",
    4941: "eq-office-4941",
    4942: "eq-office-4942",
    4949: "munin",
    ...
    5044: "lxi-evntsvc",
    5045: "osp",
    5046: "Reserved/vpm-udp",
    5047: "Reserved/iscape",
    5048: "texai",
    5049: "ivocalize",
    5050: "mmcc",
    5051: "ita-agent",
    ...
    5074: "alesquery",
    5075: "pvaccess",
    5078: "Reserved/pixelpusher",
    5079: "Reserved/cp-spxrpts",
    5080: "onscreen",
    5081: "sdl-ets",
    5082: "qcp",
    5083: "qfp",
    ...
    5090: "car",
    5091: "cxtp",
    5092: "Reserved/magpie",
    5093: "sentinel-lm",
    5094: "hart-ip",
    5099: "sentlm-srv2srv",
    5100: "socalia",
    5101: "talarian-tcp/talarian-udp",
    5102: "oms-nonsecure",
    5103: "actifio-c2c",
    5104: "Reserved/tinymessage",
    5105: "Reserved/hughes-ap",
    ...
    5114: "ev-services",
    5115: "autobuild",
    5116: "Reserved/emb-proj-cmd",
    5117: "gradecam",
    5120: "barracuda-bbs",
    5133: "nbt-pc",
    5134: "ppactivation",
    5135: "erp-scale",
    5136: "Reserved/minotaur-sa",
    5137: "ctsd",
    5145: "rmonitor-secure/rmonitor_secure",
    5146: "social-alarm",
    5150: "atmp",
    5151: "esri-sde/esri_sde",
    5152: "sde-discovery",
    5154: "bzflag",
    5155: "asctrl-agent",
    5156: "rugameonline",
    ...
    5242: "attune",
    5243: "xycstatus",
    5245: "downtools/downtools-disc",
    5246: "Reserved/capwap-control",
    5247: "Reserved/capwap-data",
    5248: "caacws",
    5249: "caaclang2",
    5250: "soagateway",
    5251: "caevms",
    ...
    5434: "sgi-arrayd",
    5435: "sceanics",
    5436: "Reserved/pmip6-cntl",
    5437: "Reserved/pmip6-data",
    5443: "spss",
    5445: "smbdirect",
    5450: "tiepie/tiepie-disc",
    5453: "surebox",
    5454: "apc-5454",
    5455: "apc-5455",
    5456: "apc-5456",
    ...
    5567: "dof-dps-mc-sec",
    5568: "sdt",
    5569: "rdmnet-ctrl/rdmnet-device",
    5573: "sdmmp",
    5574: "lsi-bobcat",
    5575: "ora-oap",
    5579: "fdtracks",
    ...
    5680: "auriga-router",
    5681: "ncxcp",
    5682: "Reserved/brightcore",
    5683: "coap",
    5684: "coaps",
    5687: "Reserved/gog-multiplayer",
    5688: "ggz",
    5689: "qmvideo",
    5693: "rbsystem",
    5696: "kmip",
    ...
    5726: "ms-ilm-sts",
    5727: "asgenf",
    5728: "io-dist-data/io-dist-group",
    5729: "openmail",
    5730: "unieng",
    5741: "ida-discover1",
    5742: "ida-discover2",
    ...
    5784: "Reserved/ibar",
    5785: "3par-rcopy",
    5786: "Reserved/cisco-redu",
    5787: "Reserved/waascluster",
    5793: "xtreamx",
    5794: "Reserved/spdp",
    5798: "enlabel-dpl",
    5813: "icmpd",
    ...
    5909: "agma",
    5910: "ats-atn/cm",
    5911: "ats-acars/cpdlc",
    5912: "ais-met/fis",
    5913: "aoc-acars/ads-c",
    5914: "ipsdtls",
    5963: "indy",
    5968: "mppolicy-v5",
    5969: "mppolicy-mgr",
