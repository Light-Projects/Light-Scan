...
user_agents = [
    ...
    "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:109.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36",
    ...
    "Mozilla/5.0 (Linux; Android 13; SM-S918B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/24.0 Chrome/115.0.0.0 Mobile Safari/537.36",
...
HTTP_PROBES = {
    1: lambda target: f"GET / HTTP/1.1\r\nHost: {target}\r\nUser-Agent: {random.choice(user_agents)}\r\nAccept: */*\r\nConnection: close\r\n\r\n".encode()
}